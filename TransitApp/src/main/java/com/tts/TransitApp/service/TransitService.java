...
import com.tts.TransitApp.DistanceResponse;
import com.tts.TransitApp.GeocodingResponse;
import com.tts.TransitApp.Location;
...
//	import everything from application.properties
	@Value("${transit_url}")
